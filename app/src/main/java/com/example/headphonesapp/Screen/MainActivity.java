package com.example.headphonesapp.Screen;
...
import com.example.headphonesapp.Adapter.MainAdapter;
...
public class MainActivity extends AppCompatActivity implements OnRecyclerItemClickListener {
    ...
    private final int[] imageList = {R.drawable.red_headphone, R.drawable.black_headphone,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCustomAnimation(descriptionLayout, 5000, R.anim.slide_in_down);
    }
